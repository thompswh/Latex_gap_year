...
% -------------------------------------- TITLE ------------------------------------------
\title{Unique Games on Metric Graphs}
...
\begin{tcolorbox}[colback=white, colframe=blue, coltitle=white, title=BRUH, boxrule=0.5pt, arc=2mm]
Inside this box, there is text
