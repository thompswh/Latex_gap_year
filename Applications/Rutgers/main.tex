...
I would be particularly excited to work with Roie Levin on approximation algorithms. My burgeoning interest in parameterized algorithms has given me an appreciation for examining approximation in various settings, whether that be allowing parameterization or using an alternate computational model, such as the online or streaming setting. Specifically, I would be interested in using the intuition I developed in reviewing the literature for clustering problems in my own research to continue Dr. Levin's recent line of work in connecting online clustering problems to the extensive body of work in the more traditional offline setting. 
