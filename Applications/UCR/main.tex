...
I would be particularly excited to work with Amey Bhangale on approximation algorithms. Specifically, I would love to continue exploring the approximability of CSPs. One aspect of my research that I thoroughly enjoyed was finding out that there exists a more general framework that encapsulates either the hardness or algorithmic challenge of whatever problem I am working on, whether that be Schaefer's original Dichotomoy Theorem, a PTAS for \emph{every} dense, fragile CSP by Karpinski and Schudy, or Raghavendra's Theorem. This meant that I was paticularly excited to learn that Dr. Bhangale has embarked on a journey towards establishing similarly total results for approximating all CSPs. I look forward to using the intuition I gained in studying CSPs in my own research problem to join him on this journey.
