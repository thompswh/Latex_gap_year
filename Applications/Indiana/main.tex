...
I would be excited to work with Suprovat Ghoshal on approximation problems and hardness of approximation. In particular, I would like to study the approximability of CSPs. Studying approximation in the context of parameterization has oriented me more towards approximation within different computational models, and so his recent work on approximating CSPs when given access to an advice oracle is especially interesting to me. I look forward to using the intuition I developed while working on my own resarch problem to further our understanding of approximating CSPs, in traditional and alternate models of computation alike.
