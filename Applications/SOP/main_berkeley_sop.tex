...
I am particularly interested in working with Professor Venkatesan Guruswami on approximation algorithms, parameterized algorithms, and CSPs. Professor Guruswami has been at the forefront of approximation algorithms and parameterized algorithms. Almost all of the state-of-the-art inapproximability results rely on the celebrated but technical PCP Theorem, and there has been an effort recently to find a similar foundation for inapproximability results for parameterized problems. I have been exploring the literature in preparation for the talk mentioned above, and this is the area that I would most like to work with Professor Guruswami on. I want to study the question of whether we need ETH (or Gap-ETH), or whether strong hardness results can be established just from the assumption that $\P \ne \NP$, as is the case with non-parameterized approximation. I also would look forward to working with Prasad Raghavendra on approximation algorithms, particularly on the ``meta" results about approximation algorithms, that is, which methods work the best, and what does that tell us about the structure of the problem? 
\end{document}
