...
One of the courses I have been auditing this year is a special topics class on parameterized and fast exponential algorithms. I previously had seen parameterized algorithms in a graph algorithms course I took during my final undergraduate semester, and the course I am auditing is being taught by a professor who mainly works in approximation algorithms, so there was more of a focus on the interaction of parameterized algorithms with approximation. I have become interested in whether or not using both parameterization and approximation can give an advantage for problems that each individual subarea suggests is hard. In pursuit of this, for my final project in the class, I am preparing a talk on a recent paper that surveys the parameterized approximability of the clique problem in order to acquaint myself with the literature.


 I would be excited to work with Mahsa Derakhshan on approximation algorithms in alternative computational models. Studying approximation's interaction with parameterization has oriented me more towards studying optimization and approximation in non-traditional computational models, such as within the online setting or having to contend with adversarially given input. My research in approximation algorithms has developed my intuition for thinking about worst-case inputs, and so I would enjoy formalizing this notion and addressing it. My recent interest in parameterized algorithms has oriented me more towards graph-theoretic problems, and so Professor Derakhshan's recent work in examining vertex cover and matching problems in the stochastic and online setting would serve as a great avenue to continue exploring these problems. I would also be interested in working with Rajmohan Rajaraman on approximation algorithms, particularly in approximating problems on networks. His recent work on establishing the complexity of propagating information on a network so as to minimize polarization and rejection of the information fascinated me because of it's real-world applicability and the abstract, algorithmic beauty of its results. I would be delighted to join him on continuing to work on such problems. 
