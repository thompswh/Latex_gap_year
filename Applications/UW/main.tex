...
I would be excited to work with Professor Mitali Bafna on establishing hardness results for parameterized approximation algorithms. She is playing an important role in laying the foundations for parameterized inapproximability results, and I would love to join her in doing so. Specifically, I really enjoyed her recent paper that strengthened time lower bounds for approximating 2-CSPs, it has been an invaluable resource for me as I bring myself to the forefront of the research on parameterized inapproximability. She also frequently uses continuous optimization tools for discrete optimization problems, which is precisely how I resolved my research problem. Working with her would be a natural next step that I would be excited to take. 
