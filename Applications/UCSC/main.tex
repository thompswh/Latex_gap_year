...
I would be particularly excited to work with Vaggos Chatziafratis on approximation algorithms. Specifically, I would be interested in working on using tools from continuous optimization to solve discrete problems, such as clustering. In my own reserach, much of the literature I reviewed was on clustering problems, and we ended up using a continuous programming relaxation to solve our problem. I was intrigued by his recent paper that similarly used a linear programming relaxation to give a PTAS for some variants of metric clustering. That paper shows that there is a PTAS on a subset of the input of my own research problem, i.e.\ when the permutations along all edges are the same function $f$ such that $f = f^{-1}$. I would be excited to continue exploring whether these techniques apply to my own research problem, and in general exploring the power of continuous optimization tools for discrete optimization problems. 
